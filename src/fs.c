...
void clear_block_by_num(Disk *disk, uint32_t block_num);
...
void    clear_block_by_num(Disk *disk, uint32_t block_num) {
    ...
    disk_write(disk, block_num, block.data);
}
